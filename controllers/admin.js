...
function admin(p_accion,id,text){
	switch(p_accion){
    case 'edit':
    ...
    columnClass: "xlarge",
    type:"green",
    content: 'url:../class/classAdmin.php?table='+a_table+'&accion='+p_accion+'&Id='+id+"&query="+a_consulta})
     break;


     case 'inseUpdate': 
        $.ajax({
     	url:"../class/classAdmin.php?table="+a_table+"&query="+a_consulta,
        type:"post",
